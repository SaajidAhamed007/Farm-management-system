    ...
    <div className="min-h-screen bg-gray-300 p-8">
      <div className="max-w-full mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-responsive-4xl font-bold text-green-700 mb-2">Issue Details</h1>
          <p className="text-responsive-lg text-gray-600">Review and resolve village issue</p>
        </div>

        {/* Issue Information */}
        <div className="bg-gray-200/90 rounded-xl shadow-lg p-6 mb-8">
          <div className="flex justify-between items-start mb-6">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                ...
                <span className="px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-responsive-sm font-medium">
                  {issue.category}
                </span>
            ...
            <div className="text-right">
              <p className="text-responsive-sm text-gray-500 mb-1">Reported:</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="space-y-4">
              <div>
                <h4 className="text-responsive-base font-semibold text-gray-700 mb-2">Description</h4>
                <p className="text-responsive-base text-gray-600 bg-gray-50 p-3 rounded-lg">{issue.description}</p>
              </div>
              <div>
                <h4 className="text-responsive-base font-semibold text-gray-700 mb-2">Reported By</h4>
                <p className="text-responsive-base text-gray-800 bg-gray-50 p-3 rounded-lg">{issue.reportedBy}</p>
              </div>
            </div>
            <div className="space-y-4">
              <div>
                <h4 className="text-responsive-base font-semibold text-gray-700 mb-2">Location</h4>
                <p className="text-responsive-base text-gray-800 bg-gray-50 p-3 rounded-lg">{issue.location}</p>
              </div>
              <div>
                <h4 className="text-responsive-base font-semibold text-gray-700 mb-2">Date Reported</h4>
                <p className="text-responsive-base text-gray-800 bg-gray-50 p-3 rounded-lg">{new Date(issue.reportedDate).toLocaleDateString()}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {isResolving && (
              <form onSubmit={handleSubmitResolution} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="mb-4">
                    <label className="block text-responsive-sm text-gray-600 mb-2">Proof Type:</label>
                    <select
                      value={resolutionData.proofType}
                      onChange={(e) => setResolutionData({ ...resolutionData, proofType: e.target.value })}
                      className="w-full md:w-auto p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-responsive-base"
                    >
